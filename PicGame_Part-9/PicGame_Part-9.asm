...
;/****************************************************************************/
;/* PicGame_Part-9 - Microchip PIC Microcontroller Repeat Game               */
;/*                  Part 9 - Low Power Sleep.                               */
;/* V1.00 2017-07-01 (C) Jason Birch                                         */
;/*                                                                          */
;/* PIC Game Programming Series to demonstrate programming a Microchip PIC   */
;/* microcontroller. This part in the series covers low power sleep mode.    */
;/****************************************************************************/
...
MODE_SELECT_END   CLRF KEY_PRESS
                  RETURN
